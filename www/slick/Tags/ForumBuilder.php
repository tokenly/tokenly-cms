...
class Slick_Tags_ForumBuilder
{
	...
	*/
	function __construct()
	{
		...
		$this->inventory = new Slick_App_Dashboard_LTBcoin_Inventory_Model; //load inventory model
		$this->user = Slick_App_Account_Home_Model::userInfo(); //load user data
		$tokenApp = $this->model->get('apps', 'ltbcoin', array(), 'slug'); //get the tokenly/ltbcoin app
