...
<div class="wrap">
	<div class="left-bar">
		...
		<?= $this->displayTag('DISPLAY_ADSPACE', array('slug' => 'blog-theme-01-network-sidebar-ad')) ?>
		<?= $this->displayTag('DISPLAY_ADSPACE', array('slug' => 'blog-theme-01-network-tall-sidebar-ad')) ?>
	</div><!-- left-bar -->
	
	<div class="main">
		<div style="margin-top: -50px;">
			<?= $this->displayTag('DISPLAY_ADSPACE', array('slug' => 'blog-theme-01-network-top-ad')) ?>
		</div>
