	...
	<li>
		...
		<div class="blog-list-info">
			...
			<div class="blog-excerpt">
				<?php
				/* disable soundcloud for now, faster load times
...
echo '</ul>	';
	...
	?>			
		...
		<p class="pull-right view-more">
			<a href="<?= SITE_URL ?>/blog?page=2">View More <i class="fa fa-chevron-right"></i></a>
		</p>
		<div class="clear"></div>
		<div class="ad large-banner center"><?= $this->displayBlock('home-ad-bottom') ?></div> <!-- second ad -->
		<div class="clear"></div>
	</div><!-- home-content -->
</div><!-- content -->
<?php
