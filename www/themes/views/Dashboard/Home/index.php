...
<p>
	Have a Magic Word? <a href="<?= SITE_URL ?>/dashboard/magic-words">Click Here</a>
</p>
<p>
...
<ul class="dash-home-stats">
	...
	if(isset($getProfile['profile']['ltbcoin-address']) AND trim($getProfile['profile']['ltbcoin-address']['value']) != ''){
		...
		echo '<li><strong>Token Balances:</strong> <a href="'.SITE_URL.'/'.$app['url'].'/inventory">Click here to go to your <em>inventory</em></a>';
